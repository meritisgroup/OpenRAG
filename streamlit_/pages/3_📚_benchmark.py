...
if col1.button(
    ...
    if st.session_state["benchmark_database"] is None:
        ...
        run_benchmark(type_bench="contexts", reset_index=reset_index, background=False)
...
if col2.button(
    ...
    if st.session_state["benchmark_database"] is None:
        ...
        run_benchmark(type_bench="answers", reset_index=reset_index, background=False)
