...
class GraphRagIndexation:
    ...
    def run_pipeline(self, config_server, chunk_size: int=1024, overlap: bool=True, reset_preprocess: bool=False):
        ...
        for db_name in dbs_name:
            ...
            if need_extraction:
                ...
                self.extract_entities(chunk_size=chunk_size, to_process_norm=docs_to_process, overlap=overlap, db_name=db_name, config_server=config_server, reset_preprocess=reset_preprocess)
