...
class SelfRagAgent(NaiveRagAgent):
    ...
    def generate_answer(self, query: str, model: str=None, nb_chunks: str=5, batch: bool=True, options_generation=None) -> str:
        ...
        if self.reformulate_query:
            (query, input_t, ouput_t, impacts, energies) = self.reformulater.reformulate(query=query, nb_reformulation=1)
            query = query[0]
