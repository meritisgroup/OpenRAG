prompts = {
    ...
    "FR": {
        ...
        "evaluate": {
            "SYSTEM_PROMPT": "Vous êtes un assistant expert chargé d'évaluer si une réponse est complète par rapport à une question.\nVous devez répondre uniquement par 'True' si la réponse est complète et correcte, sinon 'False'.",
            "QUERY_TEMPLATE": "Question :\n{query}\n\nRéponse :\n{answer}\n\nLa réponse traite-t-elle de manière complète et satisfaisante la question ? Répondez uniquement par 'True' ou 'False'."
            },
