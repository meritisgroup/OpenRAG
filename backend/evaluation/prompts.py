PROMPTS = {
    "EN": {
        ...
        "rate_from_ground_truth_absolute": {
            "SYSTEM_PROMPT": """You are an AI agent tasked with evaluating the response of an LLM model according to a specific metric.
                                You will receive: a question, the expected answer (ground truth), the answer generated by the model, and a detailed description of the evaluation metric.
        ...
        "gt_metrics": {
            ...
            "Absolute_Correctness": "Measures the factual accuracy of the agent's response."
        },
    ...
    "FR": {
        ...
        "rate_from_ground_truth_absolute": {
            "SYSTEM_PROMPT": """Vous êtes un agent IA chargé d’évaluer la réponse d’un modèle LLM selon un critère spécifique.
                                Vous recevrez : une question, des éléments de réponse attendus (vérité de terrain), la réponse générée par le modèle, ainsi qu’une description détaillée du critère d’évaluation. Les éléments donnés ne forment pas forcément une réponse complète et exhaustive mais donnent une idée de la réponse attendue.
                                Votre tâche : attribuer un score unique à la réponse du modèle pour ce critère, soit 0 soit 5, où 0 est le pire et 5 est le meilleur.
                                ...
                                Répondez uniquement avec un entier : 0 ou 5.
        ...
        "gt_metrics": {
            ...
            "Absolue_Justesse": "Mesure l'exactitude factuelle de la réponse de l'agent."
        },
        "rate_chunk_relevance": {
