...
class MarkdownOpener:
    def __init__(self, config_server : dict, overwrite=False, image_description : bool = True) -> None:
        self.overwrite = overwrite
    ...
    def open_doc(self, path_file) -> str :
        ...
        markdown_content= converter.convert(path_file, image_description=self.image_description)
